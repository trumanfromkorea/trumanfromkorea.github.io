var store = [{
        ...
        "excerpt":"2021.11 - 2022.01 우주펫 - 지역 기반 반려동물 커뮤니티 앱 2022년 12월 경 출시 현재 강남구 일대를 중심으로 서비스 중 아이폰 앱 스토어 안드로이드 플레이 스토어 업무 앱 클라이언트 개발     사용 언어 Dart 프레임워크 Flutter 협업툴 Git 개발 채팅 기능 제외 전반적인 앱 개발 진행 (v1.2.0 까지 릴리즈)...","categories": ["Projects"],
        "tags": [],
        "url": "/projects/6/",
        "teaser": null
      },{
