var store = [{
        ...
        "title": "[알고리즘] 프로그래머스 - 가장 먼 노드 (Swift, Java)",
        "excerpt":"[알고리즘] 프로그래머스 - 가장 먼 노드 (Java) 클릭해서 문제 바로가기 문제 n개의 노드가 있는 그래프가 있습니다. 각 노드는 1부터 n까지 번호가 적혀있습니다. 1번 노드에서 가장 멀리 떨어진 노드의 갯수를 구하려고 합니다. 가장 멀리 떨어진 노드란 최단경로로 이동했을 때 간선의 개수가 가장 많은 노드들을 의미합니다. 노드의 개수 n, 간선에 대한 정보가...","categories": ["Algorithm"],
        "tags": [],
        "url": "/algorithm/14/",
        "teaser": null
      },{
        ...
        "excerpt":"[알고리즘] 백준:1238 - 파티 (Swift) 클릭해서 문제 바로가기 문제 N개의 숫자로 구분된 각각의 마을에 한 명의 학생이 살고 있다. 어느 날 이 N명의 학생이 X (1 ≤ X ≤ N)번 마을에 모여서 파티를 벌이기로 했다. 이 마을 사이에는 총 M개의 단방향 도로들이 있고 i번째 길을 지나는데 Ti(1 ≤ Ti ≤...","categories": ["Algorithm"],
        "tags": [],
        "url": "/algorithm/16/",
        "teaser": null
      }]
