var store = [{
        ...
        "excerpt":"[Week 2] 22.03.26 - 22.04.01 이번 주는 바쁜 주였습니다… 지난 금요일 쏘카 코딩테스트가 있었고, 오늘 금요일에는 트래블월렛 코딩테스트와 동아리 YAPP 면접이 있었습니다. 주말에는 라인 코딩테스트와 CJ 지원서 마감이 있네요. 상당히 정신없는 일주일을 보내고 있는 것 같습니다. 코딩테스트 Tree 이번 주에는 대부분 코딩테스트를 대비해서 문제를 풀었습니다. 과 동기 민석이형이 공유해준 문제...","categories": ["Weekly"],
        "tags": [],
        "url": "/weekly/Weekly_3/",
        "teaser": null
      }]
